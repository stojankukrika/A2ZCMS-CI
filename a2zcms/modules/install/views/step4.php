...
<div class="box form">
     <div class="control-group">
        <label class="control-label" for="first_name"><?=trans('FirstName')?>:<span class="required">*</span></label>
         <div class="controls">
         	<?php echo form_input(array('name' => 'first_name', 'id' => 'first_name', 'value' => set_value('first_name'))); ?>
         </div>
    </div>
   <div class="control-group">
        <label class="control-label" for="last_name"><?=trans('LastName')?>:<span class="required">*</span></label>
         <div class="controls">
         	<?php echo form_input(array('name' => 'last_name', 'id' => 'last_name', 'value' => set_value('last_name'))); ?>
         </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="email"><?=trans('Username')?>:<span class="required">*</span></label>
         <div class="controls">
         	<?php echo form_input(array('name' => 'username', 'id' => 'username', 'value' => set_value('username','admin'))); ?>
         </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="email"><?=trans('Email')?>:<span class="required">*</span></label>
         <div class="controls">
         	<?php echo form_input(array('name' => 'email', 'id' => 'email', 'value' => set_value('email'))); ?>
         </div>
    </div>
   <div class="control-group">
        <label class="control-label" for="admin_password"><?=trans('Password')?>:<span class="required">*</span></label>
         <div class="controls">
         	<?php echo form_password(array('name' => 'admin_password', 'id' => 'admin_password')); ?>
         </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="confirm_admin_password"><?=trans('ConfirmPassword')?>:<span class="required">*</span></label>
         <div class="controls">
