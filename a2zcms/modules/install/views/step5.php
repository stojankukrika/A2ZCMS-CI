...
<div class="box form">	
	<div class="control-group">
			<label class="control-label" for="title">Site Name:<span class="required">*</span></label>
			<div class="controls">
				<?php echo form_input(array('name' => 'title', 'id' => 'title', 'value' => set_value('first_name'))); ?>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="theme">Site theme:<span class="required">*</span></label>
			<div class="controls">
				<select name="theme">
					<?php
	...
	<div class="control-group">
			<label class="control-label" for="per_page">Posts per page:<span class="required">*</span></label>
			<div class="controls">
